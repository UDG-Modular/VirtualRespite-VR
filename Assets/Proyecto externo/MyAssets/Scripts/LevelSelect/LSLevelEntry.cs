...
public class LSLevelEntry : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            //Desactivar el objeto con el dise�o activado
            mapPointActive.SetActive(false);
            //activar el objeto con dise�o inactivo
    ...
    {   
        ...
        if (Input.GetKeyDown(KeyCode.X) && canLoadLevel && _levelUnlocked && !_levelLoading)
        {
